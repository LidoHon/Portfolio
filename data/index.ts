...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently working as a Frontend Developer at Minab Tech",
...
export const projects = [
  {
    id: 1,
    title: "Zeleman Academy",
    des: 'Zeleman Academy LMS is a Learning Management System developed collaboratively by a team, where I contributed to the front-end development for both the admin dashboard and the client-facing platform. "',
    img: "/zeleman.png",
    iconLists: [
      "/nuxt.svg",
      "/tail.svg",
    ...
    link: "https://www.zelemanacademy.com/",
    // github: "https://github.com/LidoHon/Evangadi-Forum-G2.git",
  },
  {
    id: 2,
    title: "HaHu Muya LMS",
    des: 'Hahu Muya LMS is a Learning Management System developed collaboratively with a team, where I worked on the front-end implementation for both the admin panel and the client-facing application. "',
    img: "/muya.png",
    iconLists: [
      "/nuxt.svg",
      "/tail.svg",
...
export const workExperience = [
  {
    id: 1,
    title: "Frontend software developer | MInab Tech",
